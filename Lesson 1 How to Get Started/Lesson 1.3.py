...
marker_position_start = line.find(marker)
marker_position_end = marker_position_start + len(marker)
replaced = line[:marker_position_start] + replacement + line[marker_position_end:]
